...
const Navbar = () => {
  return (
    <div>
      <header className="bg-white fixed p-1 w-full top-0 h-16">
            ...
            <div className="hidden md:block">
              <nav aria-label="Global">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <a className="text-gray-800 font-bold text-lg  transition hover:text-purple-500/75 " href="#"> Home </a>
                  </li>

                  <li>
                    <a className="text-gray-800 font-bold text-lg transition hover:text-purple-500/75 " href="#"> Feed </a>
                  </li>

                  <li>
                    <a className="text-gray-800 font-bold text-lg transition hover:text-purple-500/75 " href="#"> Leader Board </a>
                  </li>

                  <li>
                    <a className="text-gray-800 font-bold text-lg  transition hover:text-purple-500/75 " href="#"> About us </a>
                  </li>

                  <li>
                    <a className="text-gray-800 font-bold text-lg transition hover:text-purple-500/75 " href="#"> Contact us </a>
                  </li>

                  {/* <li>
              <a className="text-gray-800 font-bold text-lg transition hover:text-gray-800/50" href="#"> Blog </a>
            </li> */}
                </ul>
              </nav>
            </div>
