...
function HowCanUHelp() {
    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
        ...
        <div class="w-full text-center mb-20">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">Our Solution</h1>
            <div class="flex mt-6 justify-center">
                <div class="w-16 h-1 rounded-full bg-purple-500 inline-flex"></div>
            </div>
        </div>

        <div class="w-full flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Post Availability</h2>
                    <p class="leading-relaxed">Hotel Owner posts availability of surplus food on platform.</p>
                </div>
            </div>
        </div>
                    <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Receive Notifications</h2>
                                <p class="leading-relaxed">Volunteers receive city-wise notifications for available drives.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Confirm Completion</h2>
                                <p class="leading-relaxed">Drive completion confirmed by hotel owner upon food pickup.</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Verify photos</h2>
                                <p class="leading-relaxed">Volunteers post distribution photos for verification.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Award Rewards</h2>
                                <p class="leading-relaxed">Reward points and badges awarded, showcased on leaderboard.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Provide Reports</h2>
                                <p class="leading-relaxed">Provide detailed drive and food distribution reports.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Offer Insights</h2>
                                <p class="leading-relaxed">Offer insights for reducing food wastage to Hotel owners.</p>
                            </div>
                        </div>
                    </div>
